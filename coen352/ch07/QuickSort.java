...
public class QuickSort {
	...
	static <E extends Comparable<? super E>>
	void qsortAverage(E[] A, int i, int j) {      // Quicksort

		int pivotindex = findpivotAverageCase(A, i, j); // Pick a pivot
	...
	static <E extends Comparable<? super E>>
	void qsortWorse(E[] A, int i, int j) {      // Quicksort

		int pivotindex = findpivotWorst(A, i, j); // Pick a pivot
	...
	static <E extends Comparable<? super E>>
	int findpivotWorst(E[] A, int i, int j)
	{ return j; }

	static <E extends Comparable<? super E>>
	int findpivotAverageCase(E[] A, int i, int j)
	{ return (i+j)/4; }
